...
if __name__ == "__main__":
    ...
    section_b_img1 = cv2.imread("our_images\SB1.jpeg")
    section_b_img1_gray = cv2.cvtColor(section_b_img1, cv2.COLOR_BGR2GRAY)

    section_b_img2 = cv2.imread("our_images\SB2.jpeg")
    ...
    # getImagePts(section_b_img1_gray, section_b_img2_gray, "section_b1", "section_b2", 12)
